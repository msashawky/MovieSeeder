...
if (!function_exists('moviesCategoriesURL')) {
    ...
    // Live Recently Movies URL
    if (!function_exists('recentlyMoviesURL')) {
        function recentlyMoviesURL()
        {
            return 'https://api.themoviedb.org/3/movie/upcoming?api_key=c9e5427159fb320bf4f1fc57f76a4270&language=en-US&page=1';
        }
    }
